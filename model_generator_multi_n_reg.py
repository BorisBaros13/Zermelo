# in this file we will train regularised models for multiple sample sizes
# as in model_generator.py we will store all information
...
for sim in range(num_sims):
    for n in ns:
        ...
        # generate training data and reference information
